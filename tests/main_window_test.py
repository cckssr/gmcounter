...
class TestMainWindow(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.arduino_patcher = patch("gmcounter.main_window.Arduino")
        self.gm_counter_patcher = patch("gmcounter.main_window.GMCounter")
        self.debug_patcher = patch("gmcounter.main_window.Debug")
    ...
    @patch("gmcounter.main_window.QFileDialog.getSaveFileName")
    ...
    @patch("gmcounter.main_window.QMessageBox")

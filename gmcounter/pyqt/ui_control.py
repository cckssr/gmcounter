...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", "Kontrollfenster", None))
        self.label_11.setText(
            QCoreApplication.translate("Form", "Aktuelle Einstellungen", None)
        )
        self.mode_label.setText(
            QCoreApplication.translate("Form", "Z\u00e4hl-Modus", None)
        )
        ...
        self.sModeSingle.setText(QCoreApplication.translate("Form", "Einzel", None))
        # if QT_CONFIG(tooltip)
        ...
        self.sModeMulti.setText(
            QCoreApplication.translate("Form", "Wiederholung", None)
        )
        self.query_label.setText(
            QCoreApplication.translate("Form", "Abfragemodus", None)
        )
        self.sQModeMan.setText(QCoreApplication.translate("Form", "Manuell", None))
        self.sQModeAuto.setText(QCoreApplication.translate("Form", "Automatik", None))
        self.duration_label.setText(
            QCoreApplication.translate("Form", "Z\u00e4hldauer", None)
        )
        self.sDuration.setItemText(
            0, QCoreApplication.translate("Form", "unendlich", "f0")
        )
        self.sDuration.setItemText(
            1, QCoreApplication.translate("Form", "1 Sekunde", "f1")
        )
        self.sDuration.setItemText(
            2, QCoreApplication.translate("Form", "10 Sekunden", "f2")
        )
        self.sDuration.setItemText(
            3, QCoreApplication.translate("Form", "60 Sekunden", "f3")
        )
        self.sDuration.setItemText(
            4, QCoreApplication.translate("Form", "100 Sekunden", "f4")
        )
        self.sDuration.setItemText(
            5, QCoreApplication.translate("Form", "300 Sekunden", "f5")
        )

        # if QT_CONFIG(tooltip)
        self.sDuration.setToolTip(
            QCoreApplication.translate("Form", "Wie lange der Z\u00e4hler misst", None)
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.volt_label.setToolTip(
            QCoreApplication.translate(
                "Form", "Spannung des Geiger-M\u00fcller Z\u00e4hlrohrs", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.volt_label.setText(QCoreApplication.translate("Form", "GM-Spannung", None))
        self.sVoltage.setSuffix(QCoreApplication.translate("Form", " V", None))
        # if QT_CONFIG(tooltip)
        self.controlButton.setToolTip(
            QCoreApplication.translate(
                "Form",
                "Klicken um Einstellungen an Ger\u00e4t zu \u00fcbertragen. Nur w\u00e4hrend gestoppter Messung m\u00f6glich.",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.controlButton.setText(
            QCoreApplication.translate("Form", "Einstellungen \u00e4ndern", None)
        )
        self.label_8.setText(
            QCoreApplication.translate("Form", "GM-Spannung / V", None)
        )
        # if QT_CONFIG(tooltip)
        self.cVoltage.setToolTip(
            QCoreApplication.translate("Form", "Aktuelle GM-Spannung", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.label_9.setText(
            QCoreApplication.translate("Form", "Z\u00e4hldauer / s", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(tooltip)
        self.label_10.setText(QCoreApplication.translate("Form", "Abfragemodus", None))
        self.label.setText(QCoreApplication.translate("Form", "Version", None))
        # if QT_CONFIG(tooltip)
        self.cVersion.setToolTip(
            QCoreApplication.translate("Form", "GM-Z\u00e4hler Firmware", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.cVersion.setText(QCoreApplication.translate("Form", "unknown", None))
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(tooltip)
        self.cQueryMode.setText(QCoreApplication.translate("Form", "unknown", None))
        ...
        self.cMode.setToolTip(
            QCoreApplication.translate(
                "Form", "Aktuell eingestellter Z\u00e4hlmodus", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.cMode.setText(QCoreApplication.translate("Form", "unknown", None))
